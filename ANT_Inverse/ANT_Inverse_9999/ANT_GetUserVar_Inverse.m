...
if CtrlVar.Inverse.TestAdjoint.isTrue
    ...
    elseif contains(CtrlVar.Inverse.MinimisationMethod,"Matlab")
        ...
        %% adapted by JDR 16 May to allow fmincon to stop based on walltime
        [p,UserVar,RunInfo]=InversionUsingMatlabOptimizationToolbox3(UserVar,CtrlVar,RunInfo,MUA,func,p0,plb,pub,Hfunc);
