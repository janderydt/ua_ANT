function [LakeNodes,OceanNodes,LakeElements,OceanElements] = LakeOrOcean3_JDR(CtrlVar,MUA,GF,GLgeo,GLnodes,GLele,OceanBoundaryNodes,NodesDownstreamOfGroundingLines)

% Modified by JDR on 14 Nov to accept GLgeo,GLnodes,GLele as inputs
...
GF = IceSheetIceShelves(CtrlVar,MUA,GF,GLgeo,GLnodes,GLele);
