...
switch char(BaseMesh)
    case {'2000_meshmin5000_meshmax100000','2000_meshmin1500_meshmax100000'}
        ...
        UserVar.BaseMesh.BCs = "../ANT_Data/ANT_Ua_BaseMeshGeneration/ANT_meshboundarycoordinates_"+BaseMesh+"_extrudemesh0_variableboundaryres1.mat";
        UserVar.BaseMesh.Mesh = "../ANT_Data/ANT_Ua_BaseMeshGeneration/ANT_basemesh_"+BaseMesh+"_extrudemesh0_variableboundaryres1.mat";
    case {'2000_2009_2014_2018_meshmin3000_meshmax100000'}
	% adjust and copy mesh files
	    UserVar.BaseMesh.BCs = "../ANT_Data/ANT_Ua_BaseMeshGeneration/ANT_meshboundarycoordinates_"+BaseMesh+"_extrudemesh1_variableboundaryres1.mat";
        UserVar.BaseMesh.Mesh = "../ANT_Data/ANT_Ua_BaseMeshGeneration/ANT_basemesh_"+BaseMesh+"_extrudemesh1_variableboundaryres1.mat";
