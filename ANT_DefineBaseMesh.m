...
switch char(BaseMesh)
    ...
    case {'2000_2009_2014_2018_meshmin3000_meshmax100000','2000_2009_2014_2020_meshmin1500_meshmax100000',...
            '2000_2009_2014_2018_meshmin3000_meshmax100000_refined','2000_2009_2014_2020_meshmin1500_meshmax100000_refined'}
	% adjust and copy mesh files
    ...
    case {'AMUND_2000_2009_2014_2020_meshmin1500_meshmax100000_refined','AMUND_2000_meshmin1500_meshmax100000_refined',...
           'AMUND_2009_meshmin1500_meshmax100000_refined','AMUND_2014_meshmin1500_meshmax100000_refined',...
           'AMUND_2020_meshmin1500_meshmax100000_refined'}
    % adjust and copy mesh files
        ...
        UserVar.BaseMesh.Mesh = UserVar.datafolder+"ANT_Ua_BaseMeshGeneration/AMUND_basemesh_"+erase(BaseMesh,"AMUND_")+...
            "_extrudemesh1_variableboundaryres1.mat";
